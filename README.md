...
- **08-19 ｜ 摄入 · 硬件**：大恒图像 **MARS-2442-192X2M-NF** 工业相机（CoaXPress 2.0 ／ 2440 万像素 ／ 192 fps 全局快门黑白）
...
- **08-19 ｜ 建库**：搭建 `vision-wiki/` 三层结构（raw / wiki / assets），写入家规 CLAUDE.md、知识总览、项目页五栏目模板（关键参数 / 硬件 BOM / 踩坑 root cause / 客户约定 / 代码位置）。
